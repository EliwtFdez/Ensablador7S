...
reset_color macro
    cuadro 04h, 030AH, 0C27H 
    cuadro 02h, 0327H, 0C45H 
    cuadro 01h, 0C0AH, 1527H 
    cuadro 06h, 0C27H, 1545H 
...
cambiar_q1:
    mov eleccion_temp, 1
    cuadro 0CH, 030AH, 0b26H 
    int 10h
    jmp return_cambiar_color

cambiar_q2:
    mov eleccion_temp, 2  
    cuadro 0aH, 0327H, 0b45H 
    int 10h
    jmp return_cambiar_color

cambiar_q3:
    mov eleccion_temp, 3   
    cuadro 0bH, 0C0AH, 1526H 
    int 10h
    jmp return_cambiar_color

cambiar_q4:
    mov eleccion_temp, 4 
    cuadro 0eH, 0C27H, 1545H 
    int 10h
    jmp return_cambiar_color
...
.data
    ...
    mensaje_turno_j1 db "PLAYER  1"
    mensaje_turno_j2 db "PLAYER  2"
    mensaje_turno_j3 db "PLAYER  3"
    mensaje_turno_j4 db "PLAYER  4"
    ...
    jugador_vida     db 02h, 02h, 02h, 02h
...
finalizar_click:
    ...
    inc si
    reset_color
    int 10h ; sin esto el reset color mata el Codigo
